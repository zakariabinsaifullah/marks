...
export default function Library({
    ...
    return (
        <Modal
            overlayClassName="marks-modal__overlay"
            className={`marks-modal is-${activeTab}`}
            title={__('Icons Library', 'marks')}
            onRequestClose={onClose}
            isFullScreen={true}
            headerActions={<Header activeTab={activeTab} onTabChange={onTabChange} />}
        >
            <div className="marks-modal__container">
                <Sidebar
                ...
                />
                <div className="marks-modal__content">
