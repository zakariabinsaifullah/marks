...
const VARIATION_NAME = 'marks/query-carousel';
...
addFilter('blocks.registerBlockType', 'marks/query-carousel/add-attributes', (settings, name) => {
    if (name !== 'core/query') {
        return settings;
    }
...
addFilter(
    'editor.BlockEdit',
    'marks/query-carousel/add-inspector-controls',
...
addFilter(
    ...
    'marks/query-carousel/add-classes',
    createHigherOrderComponent(BlockListBlock => {
        return props => {
            ...
            const classes = [props.className, 'marks-query-carousel'].filter(Boolean).join(' ');
